...
const About = () => {
  return (
    <div className="flex items-center justify-center bg-gray-100 max-h-max"> 
      <div className="bg-gray-300 text-sm dark:bg-gray-700 rounded-lg p-4 w-full">
        <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">About Us</h2>
        <p className="text-gray-700 leading-relaxed text-base mb-6 text-center px-60">
            Grantscraper is a scholarship search website that utilize the power of webscraping to gather scholarship from varoius sources across the internet to provide the most complete and up to date scholarship information to our users.
        </p>
        
        <div className="mb-6 text-center">
          <h3 className="text-xl font-semibold text-gray-800 mb-4">Vision</h3>
          <p className="text-gray-700 leading-relaxed text-base  text-center px-60">
        ...
        <div className="mb-6 text-center">
          ...
          <ul className="list-inside text-gray-700 leading-relaxed text-base text-center px-60">
